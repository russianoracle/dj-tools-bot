...
NO librosa import in this file!
"""
...
# Centralized librosa access
from app.common.primitives.audio_stft_loader import (
    load_audio,
    get_duration as _get_duration_librosa,
)
...
class AudioLoader:
    ...
    def load(
        ...
        try:
            ...
            # Use centralized load_audio from audio_stft_loader
            y, sr = load_audio(
                str(file_path),
                sr=self.sample_rate,
                mono=True,
    ...
    def get_duration(self, file_path: str) -> float:
        ...
        try:
            ...
            # Fallback to centralized librosa function
            try:
                return _get_duration_librosa(str(file_path))
