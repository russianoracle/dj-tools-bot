...
BLOCKED (will raise ImportError):
    from app.common.primitives import compute_rms  # ❌ BLOCKED
    from app.common.primitives import compute_centroid  # ❌ BLOCKED
...
# Import directly from submodules: from app.common.primitives.rhythm import compute_onset_strength
# =============================================================================
# Tasks that need blocked functions should import from submodules directly:
#   from app.common.primitives.rhythm import compute_onset_strength  # Internal use OK
#   from app.common.primitives.harmonic import compute_hpss          # Internal use OK
