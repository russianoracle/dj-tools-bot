...
# Import from primitives public API - using STFTCache for cached features
from .primitives.stft import STFTCache, compute_stft
from .primitives.energy import FrequencyBands, compute_frequency_bands
from .primitives.spectral import compute_brightness, SpectralFeatures
from .primitives.rhythm import compute_tempo_multi
from .primitives.dynamics import detect_peaks, compute_novelty, compute_buildup_score
from .primitives.filtering import smooth_gaussian, normalize_minmax
...
from .primitives.rhythm import compute_onset_strength as _compute_onset_strength_numpy
